# Лабораторная работа №1: Параллельное умножение матриц на GPU (CUDA)
...
**Рекомендации:**
- Для матриц размером 800×800 рекомендуется использовать блок 8×8 или 16×16
- Для матриц размером 1200×1200 оптимален блок 16×16
- Для матриц размером 1600×1600 лучшие результаты показывают блоки 8×8 и 32×32
- Для матриц размером 2000×2000 оптимален блок 16×16
